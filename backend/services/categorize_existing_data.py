...
def categorizar_producto(texto):
    ...
    categorias = {
        "tecnología": ["apple","5g","4g","telefono","teléfono","reno10","reno12","8gb","oppo","huawei","realme","motorola","samsung","512 gb","64 gb","128 gb","8 gb","4 gb","sim","xiaomi", "iphone","4gb","8gb","16gb", "celular", "laptop", "computador", "tablet", "tecnología", "audífono", "monitor", "teclado", "mouse", "tv", "televisor", "smartphone", "impresora", "cámara", "usb", "disco duro", "ssd", "memoria ram", "procesador", "notebook", "gamer", "playstation", "xbox", "nintendo"],
